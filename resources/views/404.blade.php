  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4 offset-md-4 col-sm-4 offset-sm-4">
            <div class="code text-theme mt-5 mb-2"><h1><i class="fas fa-spinner fa-spin mr-2"></i></h1>404</div>
            ...
            <div class="form-group mb-2">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button class="btn button-custom rounded-0"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </div>
    ...
    <script src="/assets/backendjs/jquery-1.12.4.min.js"></script>
    <!--Popper JS-->
    <script src="/assets/backend/css/js/popper.min.js"></script>
    <!--Bootstrap-->
    <script src="/assets/backend/css/js/bootstrap.min.js"></script>
    <!--Sweet alert JS-->
    <!--Custom Js Script-->
