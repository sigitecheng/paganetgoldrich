...
<body class="font-poppins text-[#292E4B] bg-[#F6F9FC]">
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden">
        ...
        ">
                ...
                <p class="font-semibold text-white" style="font-size: 14px">Tangan Membantu Menginspirasi Perubahan Bersama</p>
            </div>
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex gap-1 items-center">
                            <p class="font-semibold text-sm">{{$data->nama_pemilik}}</p>
